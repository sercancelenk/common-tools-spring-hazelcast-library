package common.tools.hazelcast.util.cache.impl;
...
import common.tools.hazelcast.util.cache.CacheStore;
...
public class HazelcastCacheStore<K, V> implements CacheStore<K, V> {

    public Logger getLogger(){ return LoggerFactory.getLogger(CacheConfig.class); }
    ...
    public HazelcastCacheStore(HazelcastInstance hazelcastInstance, String mapName) {
        ...
        getLogger().info("[Common] [Hazelcast Cache Store] initialized for map {}]", mapInfo);
    }
